...
<body style="background-color:<?php echo get_option('backround_color'); ?>">
	<nav class="social-media-nav">
		<ul class="social-media-nav-list">
			<li>
				<a href="<?php echo get_option('soundcloud'); ?>" target="_blank"><i class="fab fa-soundcloud"></i></a>
			</li> 
			<li>
				<a href="<?php echo get_option('instagram'); ?>" target="_blank"><i class="fab fa-instagram"></i></a>
			</li>
			<li>
				<a href="<?php echo get_option('twitter'); ?>" target="_blank"><i class="fab fa-twitter"></i></a>
			</li> 
			<li>
				<a href="<?php echo get_option('facebook'); ?>" target="_blank"><i class="fab fa-facebook"></i></a>
			</li>
		</ul> 
	</nav>
